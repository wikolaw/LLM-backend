    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full h-24 p-3 bg-white text-gray-900 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
      ...
      {optimizedPrompt && (
        <div>
          ...
          <textarea
            ...
            className="w-full h-40 p-3 bg-white text-gray-900 text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
          />
          <div className="flex items-center justify-end mt-2">
            <button
          ...
          <textarea
            ...
            className={`w-full h-64 p-3 border rounded-lg focus:ring-2 focus:border-transparent font-mono text-xs ${
              schemaValid
                ...
                : 'border-red-300 bg-red-50 text-gray-900 focus:ring-red-500'
            }`}
          />
        </div>
      )}
        ...
        <div className="border-2 border-green-200 rounded-lg bg-green-50 p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="bg-white border-2 border-blue-300 rounded-lg p-4 max-h-48 overflow-y-auto">
